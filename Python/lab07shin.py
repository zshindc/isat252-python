# Program that displays statistical calculations of water quality data
# for Friends of Shenandoah River
...
def main():
    ...
    while file == None:
        ...
        if (filename.lower() == "labph.txt"):
            ...
            print("The program cannot find the file inputed.")
    ...
    print("The program measured " + \
        ...
        ".")
    print("This program collected the data from " + filename + " that is by Friends of the Shenandoah River.")
